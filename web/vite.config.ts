...
export default defineConfig({
  ...
  plugins: [react(), VitePWA({
    ...
    workbox: {
      ...
      // /retro, /shmup or /chase stayed on the old build until the player accepted the
      ...
      globIgnores: ['**/node_modules/**/*', 'retro.html', 'shmup.html', 'chase.html'],
      // /retro, /shmup and /chase are separate games (retro.html, shmup.html,
      // chase.html), not routes of this app — never let an unmatched
      // navigation there fall back to index.html. Case-insensitive so /Retro
      // reaches the network and public/404.html can redirect it.
      navigateFallbackDenylist: [/^\/(retro|shmup|chase)/i],
    },
    manifest: {
