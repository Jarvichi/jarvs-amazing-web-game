...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  // Campaign 2, Act 7 — The Mirror Marsh
  {
    id: 'campaign:c2act7:1',
    name: 'First Reflection',
    description: 'Complete Campaign 2 Act 7 — The Mirror Marsh',
    category: 'campaign',
    progressKey: 'campaign:c2act7',
    target: 1,
    reward: { type: 'crystals', crystals: 800 },
    tier: 1,
  },
  {
    id: 'campaign:c2act7:10',
    name: 'Tallied by the Still Ledger',
    description: 'Complete Campaign 2 Act 7 ten times',
    category: 'campaign',
    progressKey: 'campaign:c2act7',
    target: 10,
    reward: { type: 'crystals', crystals: 3800 },
  ...
  {
    id: 'campaign:c2act7:100',
    name: 'The Marsh Remembers Your Face',
    description: 'Complete Campaign 2 Act 7 one hundred times',
    category: 'campaign',
    progressKey: 'campaign:c2act7',
    target: 100,
    reward: {
      type: 'item',
      item: { id: 'reflections_backwards_pane', name: "Reflection's Backwards Pane", icon: '🪞', desc: 'A pane from a hundred crossings. It has never once shown you a world that wasn\'t true.' },
    },
    tier: 2,
  },
  ...
  {
    id: 'miniGame:first_play',
    name: 'First Coin Drop',
    description: 'Play your first arcade mini game.',
    category: 'misc',
  ...
  },
  {
    id: 'miniGame:play_10',
    name: 'Arcade Regular',
    description: 'Play 10 arcade mini games.',
    category: 'misc',
    progressKey: 'miniGame:gamesPlayed',
    target: 10,
    reward: { type: 'crystals', crystals: 100 },
  ...
  },
  {
    id: 'miniGame:play_50',
    name: 'Token Hoarder',
    description: 'Play 50 arcade mini games.',
    category: 'misc',
    progressKey: 'miniGame:gamesPlayed',
    target: 50,
    reward: { type: 'crystals', crystals: 250 },
  ...
  {
    id: 'miniGame:earn_1000',
    name: 'Big Winner',
    description: 'Earn a total of 1,000 arcade tickets.',
    category: 'misc',
    progressKey: 'miniGame:ticketsEarned',
    target: 1000,
  ...
  {
    id: 'miniGame:redeem_1',
    name: 'Claim It',
    description: 'Redeem your first arcade prize.',
    category: 'misc',
    progressKey: 'miniGame:prizesRedeemed',
    target: 1,
    reward: { type: 'crystals', crystals: 75 },
    tier: 1,
  },
  ...
  },
  {
    ...
    category: 'misc',
    progressKey: 'miniGame:marble:bestScore',
    target: 100,
    reward: { type: 'cards', count: 1 },
    tier: 1,
  },
  {
    id: 'miniGame:tileflip_perfect',
    name: 'Photographic Memory',
    description: 'Complete Tile Flip without a single mistake.',
    category: 'misc',
    progressKey: 'miniGame:tileflip:perfectGames',
    target: 1,
    reward: { type: 'cards', cardName: undefined, count: 1 },
    tier: 2,
  },
  {
    id: 'miniGame:crystalcatch_50',
    name: 'Crystal Magnet',
    description: 'Earn 50 tickets in a single Crystal Catch round.',
    category: 'misc',
    progressKey: 'miniGame:crystalcatch:bestScore',
    target: 50,
    reward: { type: 'cards', count: 1 },
    tier: 1,
  },
  {
    id: 'miniGame:spinner_jackpot',
    name: 'Lucky Break',
    description: 'Hit the jackpot on the Lucky Spinner.',
    category: 'misc',
    progressKey: 'miniGame:spinner:jackpots',
    target: 1,
    reward: { type: 'crystals', crystals: 150 },
    tier: 1,
  },
  ...
  // ─── Secret Rarity Achievements ──────────────────────────
  {
    id: 'secret:first_any',
    name: 'Fortune Favours the Drawn',
    description: 'Obtain your first secret-rare card of any kind.',
    category: 'misc',
    progressKey: 'secret:any',
    target: 1,
    reward: { type: 'crystals', crystals: 200 },
    tier: 2,
  },
  {
    id: 'secret:shiny_first',
    name: 'Gold in the Gut',
    description: 'Draw a Shiny card.',
    category: 'misc',
    progressKey: 'secret:shiny',
    target: 1,
    reward: { type: 'crystals', crystals: 150 },
    tier: 2,
  },
  {
    id: 'secret:holofoil_first',
    name: 'Prism Touch',
    description: 'Draw a Holofoil card.',
    category: 'misc',
    progressKey: 'secret:holofoil',
    target: 1,
    reward: { type: 'crystals', crystals: 150 },
    tier: 2,
  },
  {
    id: 'secret:glass_first',
    name: 'Handle with Care',
    description: 'Draw a Glass card.',
    category: 'misc',
    progressKey: 'secret:glass',
    target: 1,
    reward: { type: 'crystals', crystals: 150 },
    tier: 2,
  },
  {
    id: 'secret:mythic_first',
    name: 'Beyond Legend',
    description: 'Draw a Mythic card.',
    category: 'misc',
    progressKey: 'secret:mythic',
    target: 1,
    reward: { type: 'crystals', crystals: 500 },
    tier: 2,
  },
  {
    ...
    description: 'Obtain 5 secret-rare cards in total.',
    category: 'misc',
    progressKey: 'secret:any',
    target: 5,
    reward: { type: 'cards', count: 3, bonusCrystals: 200 },
    tier: 2,
  },
  {
    id: 'secret:glass_shattered_first',
    name: 'Too Fragile for This World',
    description: 'Play a Glass card that shatters on deployment.',
    category: 'misc',
    progressKey: 'secret:glass_shattered',
    target: 1,
    reward: { type: 'crystals', crystals: 100 },
    tier: 1,
  },
  {
    id: 'secret:glass_shattered_5',
    name: 'Butterfingers',
    description: 'Have 5 Glass cards shatter on deployment.',
    category: 'misc',
    progressKey: 'secret:glass_shattered',
    target: 5,
    reward: { type: 'crystals', crystals: 250 },
  ...
  },
  {
    ...
    description: 'Obtain at least one card of each secret rarity (Shiny, Holofoil, Glass, Mythic).',
    category: 'misc',
    progressKey: 'secret:types_seen',
    target: 4,
    reward: { type: 'crystals', crystals: 1000 },
    tier: 2,
  },
  {
    ...
    description: 'Obtain 3 Mythic cards.',
    category: 'misc',
    progressKey: 'secret:mythic',
    target: 3,
  ...
  // ─── Marble Race Achievements ─────────────────────────────
  {
    id: 'miniGame:marblerace_first',
    name: 'Off to the Races',
    description: 'Score at least 1 ticket in Marble Race.',
    category: 'misc',
    progressKey: 'miniGame:marblerace:bestScore',
    target: 1,
    reward: { type: 'crystals', crystals: 25 },
    tier: 1,
  },
  {
    id: 'miniGame:marblerace_50',
    name: 'Photo Finish',
    description: 'Score 50 tickets in a single Marble Race session.',
    category: 'misc',
    progressKey: 'miniGame:marblerace:bestScore',
    target: 50,
    reward: { type: 'cards', count: 1 },
  ...
  {
    id: 'miniGame:marblerace_200',
    name: 'Track Legend',
    description: 'Score 200 tickets in a single Marble Race session.',
    category: 'misc',
    progressKey: 'miniGame:marblerace:bestScore',
    target: 200,
    reward: { type: 'cards', count: 3 },
  ...
  // ─── Higher or Lower Achievements ────────────────────────
  {
    ...
    name: 'Feeling Lucky',
    description: 'Score at least 1 in Higher or Lower.',
    category: 'misc',
    progressKey: 'miniGame:higherOrLower:bestScore',
    target: 1,
    reward: { type: 'crystals', crystals: 25 },
    tier: 1,
  },
  {
    id: 'miniGame:hol_10',
    name: 'On a Roll',
    description: 'Score 10 in a single Higher or Lower session.',
    category: 'misc',
    progressKey: 'miniGame:higherOrLower:bestScore',
    target: 10,
    reward: { type: 'cards', count: 1 },
  ...
  {
    id: 'miniGame:hol_25',
    name: 'Unbeatable Intuition',
    description: 'Score 25 in a single Higher or Lower session.',
    category: 'misc',
    progressKey: 'miniGame:higherOrLower:bestScore',
    target: 25,
    reward: { type: 'cards', count: 3 },
  ...
  // ─── Fruit Machine Achievements ───────────────────────────
  {
    id: 'miniGame:fruit_first',
    name: 'Pull the Lever!',
    description: 'Score at least 1 ticket on the Fruit Machine.',
    category: 'misc',
    progressKey: 'miniGame:fruitMachine:bestScore',
    target: 1,
    reward: { type: 'crystals', crystals: 25 },
    tier: 1,
  },
  {
    id: 'miniGame:fruit_100',
    name: 'Triple Cherries',
    description: 'Score 100 tickets in a single Fruit Machine session.',
    category: 'misc',
    progressKey: 'miniGame:fruitMachine:bestScore',
    target: 100,
    reward: { type: 'cards', count: 2 },
    tier: 1,
  },
  {
    id: 'miniGame:fruit_300',
    name: 'Lucky Streak',
    description: 'Score 300 tickets in a single Fruit Machine session.',
    category: 'misc',
    progressKey: 'miniGame:fruitMachine:bestScore',
    target: 300,
    reward: { type: 'cards', count: 5 },
  ...
  // ─── Video Poker Achievements ─────────────────────────────
  {
    id: 'miniGame:poker_first',
    name: 'Dealt In',
    description: 'Play a hand of Video Poker.',
    category: 'misc',
    progressKey: 'miniGame:videoPoker:bestScore',
    target: 1,
    reward: { type: 'crystals', crystals: 25 },
    tier: 1,
  },
  {
    id: 'miniGame:poker_50',
    name: 'Full House',
    description: 'Score 50 in a single Video Poker session.',
    category: 'misc',
    progressKey: 'miniGame:videoPoker:bestScore',
    target: 50,
    reward: { type: 'cards', count: 1 },
  ...
  {
    id: 'miniGame:poker_200',
    name: 'Royal Flush',
    description: 'Score 200 in a single Video Poker session.',
    category: 'misc',
    progressKey: 'miniGame:videoPoker:bestScore',
    target: 200,
    reward: { type: 'cards', count: 3 },
  ...
  {
    id: 'miniGame:fishing_first',
    name: "Gone Fishin'",
    description: 'Catch your first fish.',
    category: 'misc',
    progressKey: 'miniGame:fishing:bestScore',
    target: 1,
    reward: { type: 'crystals', crystals: 25 },
    tier: 1,
  },
  {
    id: 'miniGame:fishing_haul',
    name: 'Reel Expert',
    description: 'Score 100 tickets in a single Fishing session.',
    category: 'misc',
    progressKey: 'miniGame:fishing:bestScore',
    target: 100,
    reward: { type: 'cards', count: 2 },
  ...
  {
    id: 'miniGame:fishing_big',
    name: 'Big Catch',
    description: 'Catch a fish weighing over 500 g.',
    category: 'misc',
    progressKey: 'miniGame:fishing:bestWeightG',
    target: 500,
    reward: { type: 'cards', count: 1 },
    tier: 1,
  },
  {
    id: 'miniGame:fishing_monster',
    name: "The One That Almost Got Away",
    description: 'Catch a fish weighing over 1,000 g.',
    category: 'misc',
    progressKey: 'miniGame:fishing:bestWeightG',
    target: 1000,
    reward: { type: 'cards', count: 3 },
  ...
  {
    id: 'miniGame:td_first',
    name: 'Tower Commander',
    description: 'Score at least 1 in Tower Defence.',
    category: 'misc',
    progressKey: 'miniGame:towerDefence:bestScore',
    target: 1,
    reward: { type: 'crystals', crystals: 25 },
    tier: 1,
  },
  {
    id: 'miniGame:td_100',
    name: 'Defender',
    description: 'Score 100 in a single Tower Defence session.',
    category: 'misc',
    progressKey: 'miniGame:towerDefence:bestScore',
    target: 100,
    reward: { type: 'cards', count: 1 },
  ...
  },
  {
    id: 'miniGame:td_500',
    name: 'Unbreakable',
    description: 'Score 500 in a single Tower Defence session.',
    category: 'misc',
    progressKey: 'miniGame:towerDefence:bestScore',
    target: 500,
    reward: { type: 'cards', count: 3 },
  ...
  },
  {
    id: 'miniGame:td_1000',
    name: 'Bastion',
    description: 'Score 1,000 in a single Tower Defence session.',
    category: 'misc',
    progressKey: 'miniGame:towerDefence:bestScore',
    target: 1000,
    reward: { type: 'cards', count: 5 },
