...
export const C2Act6: Story = { name: 'Ch2 Act 6', args: { initialActId: 'c2act6' } }
export const C2Act7: Story = { name: 'Ch2 Act 7', args: { initialActId: 'c2act7' } }
export const C2Act8: Story = { name: 'Ch2 Act 8', args: { initialActId: 'c2act8' } }
export const C2Act9: Story = { name: 'Ch2 Act 9', args: { initialActId: 'c2act9' } }
export const C2Act10: Story = { name: 'Ch2 Act 10', args: { initialActId: 'c2act10' } }
export const C2Act11: Story = { name: 'Ch2 Act 11', args: { initialActId: 'c2act11' } }
export const C2Act12: Story = { name: 'Ch2 Act 12', args: { initialActId: 'c2act12' } }
export const C2Act13: Story = { name: 'Ch2 Act 13', args: { initialActId: 'c2act13' } }
export const C2Finale: Story = { name: 'Ch2 Finale', args: { initialActId: 'c2finale' } }
export const World: Story = { name: 'World Battles', args: { initialActId: 'worldbattles' } }
