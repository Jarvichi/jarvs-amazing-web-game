...
export type Scene = 'platform' | 'shooter' | 'racer' | 'missile' | 'quest' | 'maze'
...
export const GAMES: ArcadeGame[] = [
  ...
  {
    path: '/haul', title: 'MIDNIGHT HAUL', blurb: 'KNOCK. GRAB. RUN HOME',
    hiscoreKey: 'jawg-haul-hiscore', scene: 'maze', colour: 9,
  },
]
