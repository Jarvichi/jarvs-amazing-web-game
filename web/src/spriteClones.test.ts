...
const ALLOWED_SPRITE_CLONES = new Map<string, string>([
  ...
  [groupKey(['beacon-sentry.svg', 'reading-room-sentry.svg']), 'pending redraw — tracked in #2333'],
  ...
  [groupKey(['candle-automaton.svg', 'cataloguer-automaton.svg']), 'pending redraw — tracked in #2333'],
  ...
  [groupKey(['shelf-barricade.svg', 'wax-barricade.svg']), 'pending redraw — tracked in #2333'],
  ...
  [groupKey(['company-courier.svg', 'sealed-courier.svg']), 'pending redraw — tracked in #2333'],
  ...
  [groupKey(['stackbound-knight.svg', 'wickbound-knight.svg']), 'pending redraw — tracked in #2333'],
