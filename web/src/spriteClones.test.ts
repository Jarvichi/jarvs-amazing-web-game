...
const ALLOWED_SPRITE_CLONES = new Map<string, string>([
  ...
  [groupKey(['beacon-sentry.svg', 'effigy-watch.svg', 'reading-room-sentry.svg']), 'pending redraw — tracked in #2333'],
  ...
  [groupKey(['grain-palisade.svg', 'shelf-barricade.svg', 'wax-barricade.svg']), 'pending redraw — tracked in #2333'],
